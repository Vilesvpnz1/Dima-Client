(function() {
    if (document.getElementById('dima-client-container')) {
        alert('Dima is already active or was not properly dismissed.');
        return;
    }
    ...
    const stylesString = `
        :root {
           --dima-bg-dark: #1a1a1a; --dima-bg-light: #2a2a2a; --dima-accent: #2196f3;
           --dima-text: #ffffff; --dima-text-bright: #ffffff; --dima-border: #2196f3;
           --dima-shadow: rgba(33, 150, 243, 0.3); --dima-shadow-light: rgba(33, 150, 243, 0.3);
           --dima-success: #2196f3; --dima-danger: #2196f3; --dima-rainbow-speed: 4s;
        ...
        #${DIMA_CLIENT_ID}.dima-minimized {
            width: 180px;
            min-height: var(--dima-control-bar-height);
            max-height: var(--dima-control-bar-height);
            height: var(--dima-control-bar-height);
            border-radius: 22px 22px 22px 22px / 32px 32px 32px 32px;
            background: linear-gradient(135deg, #23272f 60%, #2196f3 100%);
        ...
        #${DIMA_CLIENT_ID}.dima-minimized > *:not(#dima-control-bar) {
            display: none !important;
        }
        #${DIMA_CLIENT_ID}.dima-minimized #dima-control-bar {
            background: transparent !important;
            border-bottom: none !important;
            box-shadow: none !important;
            color: #fff;
        }
        #${DIMA_CLIENT_ID}.dima-minimized #dima-control-bar-title {
            font-size: 0.95em;
            white-space: nowrap;
            overflow: hidden;
        ...
        #${DIMA_CLIENT_ID}.dima-minimized .dima-window-controls button {
            font-size: 1.2em;
            padding: 0 4px;
        }
        ...
        #dima-key-screen {
            ...
            background: linear-gradient(135deg, #2a2a2a 60%, #2196f3 100%);
            border-radius: 16px;
        ...
        .dima-nav-item.active, .dima-nav-item.active * { color: #2196f3 !important; border-color: #2196f3 !important; }
        ...
        .dima-proxy-input {
            background-color: var(--dima-bg-dark) !important;
            color: var(--dima-text-bright) !important;
            border: 1px solid var(--dima-border) !important;
            flex-grow: 1;
            border-radius: 8px;
            padding: 10px;
            font-size: 0.9em;
    ...
    const keyScreenHTMLString = `
        <div id="dima-key-screen">
            ...
            <div id="dima-key-title" style="cursor:move;">Dima</div>
    ...
    let mainMenuHTMLString = `
        <div id="dima-control-bar">
            <span id="dima-control-bar-title">Dima</span>
        ...
        <div id="dima-main-interface">
            <div id="dima-sidebar">
                ...
                <div class="dima-nav-item" data-section="ai">
                    <svg viewBox="0 0 24 24" width="18" height="18"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>
                    AI
                </div>
            ...
            <div id="dima-content-area">
                <div id="dima-content-section-proxy" class="dima-content-section active">
                    ...
                    <div class="dima-card"><div class="dima-card-title">Alternative Proxy</div><div id="dima-proxy-section-alt" style="display: flex; align-items: center; gap: 10px;"><input type="text" id="dima-proxy-input-alt" class="dima-proxy-input" placeholder="Backup proxy if main one fails"><button id="dima-proxy-button-alt" class="dima-action-button">Go</button></div><div style="margin-top:8px;font-size:0.92em;color:#2196f3;opacity:0.85;">Note: After clicking Go, you must click <b>Go</b> again on the CroxyProxy page to continue.</div></div>
    ...
    <div class="dima-card">
        ...
        <div id="dima-console-log-viewer" style="background:#181818;color:#fff;padding:10px;height:220px;overflow:auto;font-family:monospace;font-size:0.95em;border-radius:8px;border:1px solid #333;"></div>
                ...
                <div id="dima-content-section-chat" class="dima-content-section">
                    <div class="dima-card" style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 140px; background: linear-gradient(135deg, #2a2a2a 60%, #2196f3 100%); box-shadow: 0 4px 24px rgba(33,150,243,0.15);">
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" viewBox="0 0 24 24" style="margin-bottom: 10px;"><path fill="#2196f3" d="M12 2c-.41 0-.77.25-.93.63l-9 20A1 1 0 0 0 3 24h18a1 1 0 0 0 .93-1.37l-9-20A1 1 0 0 0 12 2zm0 3.3L19.18 22H4.82L12 5.3zM11 9h2v5h-2V9zm0 6h2v2h-2v-2z"/></svg>
                        <span style="color: #2196f3; font-size: 1.5em; font-weight: bold; letter-spacing: 1px; text-shadow: 0 2px 8px rgba(33,150,243,0.2);">Under Construction!</span>
                    </div>
                </div>
                <div id="dima-content-section-script" class="dima-content-section">
                     <div class="dima-card">
                        ...
                        <div class="dima-card" style="margin-top:18px;background:linear-gradient(135deg,#2a1818 60%,#2196f3 100%);box-shadow:0 2px 12px rgba(33,150,243,0.18);padding:18px 20px 12px 20px;">
                            <div style="font-size:1.08em;font-weight:600;color:#2196f3;margin-bottom:10px;letter-spacing:0.5px;display:flex;align-items:center;gap:8px;">
                                <svg width="20" height="20" fill="none" viewBox="0 0 24 24"><path d="M4 4h16v16H4V4zm2 2v12h12V6H6zm2 2h8v8H8V8z" fill="#2196f3"/></svg>
                            ...
                            <ul style="list-style:none;padding:0;margin:0;">
                                <li style="margin-bottom:10px;">
                                    <a href="https://github.com/randomstuff69/blooketcheatsplus/blob/main/GUI/Gui.js" target="_blank" style="display:flex;align-items:center;gap:10px;text-decoration:none;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);transition:background 0.2s;box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        Blooket Cheats
                                        <span style="margin-left:auto;font-size:0.92em;color:#2196f3;background:rgba(33,150,243,0.08);padding:2px 8px;border-radius:6px;">JavaScript</span>
                                    </a>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        Rick Roll Spam
                                        <button id="dima-copy-rickroll" style="margin-left:auto;padding:2px 8px;border-radius:4px;border:none;background:rgba(33,150,243,0.1);color:#2196f3;cursor:pointer;font-size:0.85em;font-weight:600;transition:background 0.2s;">Copy Code</button>
                                    </div>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        Fake Loading Screen
                                        <button id="dima-copy-fakeloader" style="margin-left:auto;padding:2px 8px;border-radius:4px;border:none;background:rgba(33,150,243,0.1);color:#2196f3;cursor:pointer;font-size:0.85em;font-weight:600;transition:background 0.2s;">Copy Code</button>
                                    </div>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        X-Ray Vision (show borders of all elements)
                                        <button id="dima-copy-xray" style="margin-left:auto;padding:2px 8px;border-radius:4px;border:none;background:rgba(33,150,243,0.1);color:#2196f3;cursor:pointer;font-size:0.85em;font-weight:600;transition:background 0.2s;">Copy Code</button>
                                    </div>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        Element Remover Tool (click to delete any element)
                                        <button id="dima-copy-remover" style="margin-left:auto;padding:2px 8px;border-radius:4px;border:none;background:rgba(33,150,243,0.1);color:#2196f3;cursor:pointer;font-size:0.85em;font-weight:600;transition:background 0.2s;">Copy Code</button>
                                    </div>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        QR Code Generator
                                        <button id="dima-copy-qrcode" style="margin-left:auto;padding:2px 8px;border-radius:4px;border:none;background:rgba(33,150,243,0.1);color:#2196f3;cursor:pointer;font-size:0.85em;font-weight:600;transition:background 0.2s;">Copy Code</button>
                                    </div>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        ...
                                        <button id="dima-copy-tts" style="margin-left:auto;padding:2px 8px;border-radius:4px;border:none;background:rgba(33,150,243,0.1);color:#2196f3;cursor:pointer;font-size:0.85em;font-weight:600;transition:background 0.2s;">Copy Code</button>
                                    </div>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        Fireworks on Click
                                        <button id="dima-copy-fireworks" style="margin-left:auto;padding:2px 8px;border-radius:4px;border:none;background:rgba(33,150,243,0.1);color:#2196f3;cursor:pointer;font-size:0.85em;font-weight:600;transition:background 0.2s;">Copy Code</button>
                                    </div>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <a href="https://github.com/jokeri2222/KaHack/blob/main/KaHack!.user.js" target="_blank" style="display:flex;align-items:center;gap:10px;text-decoration:none;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);transition:background 0.2s;box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        KaHack (Kahoot Cheats)
                                        <span style="margin-left:auto;font-size:0.92em;color:#2196f3;background:rgba(33,150,243,0.08);padding:2px 8px;border-radius:6px;">JavaScript</span>
                                    </a>
                                </li>
                                <li style="margin-bottom:10px;">
                                    <a href="https://github.com/jokeri2222/Quizlet-Hack/blob/main/QuizletHack.user.js" target="_blank" style="display:flex;align-items:center;gap:10px;text-decoration:none;background:rgba(255,255,255,0.04);border-radius:8px;padding:10px 14px;color:var(--dima-text-bright);transition:background 0.2s;box-shadow:0 1px 4px rgba(0,0,0,0.07);font-weight:500;">
                                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" fill="#2196f3"/></svg>
                                        Quizlet Hack
                                        <span style="margin-left:auto;font-size:0.92em;color:#2196f3;background:rgba(33,150,243,0.08);padding:2px 8px;border-radius:6px;">JavaScript</span>
                                    </a>
                ...
                <div id="dima-content-section-settings" class="dima-content-section">
                    <div class="dima-card">
                        <div class="dima-card-title" style="display: flex; align-items: center; justify-content: center; gap: 10px;">
                            <span>About</span>
                            <span style="color: #2196f3; font-size: 1.2em; font-weight: 600;">Dima</span>
                        </div>
                        <div class="dima-about-info">
                            <p class="version">Version: V12</p>
                            <p>Made By Bozzz and Kona</p>
                            <p style="color: #2196f3; font-weight: 500; margin-top: 8px; font-size: 1.1em;">Modified By Wekilledtheunicorns</p>
                        </div>
                    </div>
                    <div class="dima-card">
    ...
    const scriptParts = [
        ...
        "const keyTitleElement = document.getElementById('dima-key-title');",
        "let isDraggingKeyScreen = false;",
        "let keyScreenOffsetX = 0;",
        "let keyScreenOffsetY = 0;",

        "if (keyTitleElement) {",
        "    keyTitleElement.onmousedown = function(e) {",
        "        if (e.target.closest('#dima-key-close-btn')) return;",
        "        isDraggingKeyScreen = true;",
        "        keyScreenOffsetX = e.clientX - keyScreenElement.offsetLeft;",
        "        keyScreenOffsetY = e.clientY - keyScreenElement.offsetTop;",
        "        keyTitleElement.style.cursor = 'grabbing';",
        "        e.preventDefault();",
        "    };",
        "}",

        "document.addEventListener('mousemove', function(e) {",
        "    if (!isDraggingKeyScreen) return;",
        "    const newX = e.clientX - keyScreenOffsetX;",
        "    const newY = e.clientY - keyScreenOffsetY;",
        "    const maxX = window.innerWidth - keyScreenElement.offsetWidth;",
        "    const maxY = window.innerHeight - keyScreenElement.offsetHeight;",
        "    keyScreenElement.style.left = Math.max(0, Math.min(newX, maxX)) + 'px';",
        "    keyScreenElement.style.top = Math.max(0, Math.min(newY, maxY)) + 'px';",
        "});",

        "document.addEventListener('mouseup', function() {",
        "    if (isDraggingKeyScreen) {",
        "        isDraggingKeyScreen = false;",
        "        if (keyTitleElement) keyTitleElement.style.cursor = 'move';",
        "    }",
        "});",
        ...
        "if (proxyButtonElement) { proxyButtonElement.onclick = function() { let url = proxyInputElement ? proxyInputElement.value.trim() : ''; if (!url) { showDimaNotification('Please enter a URL.'); return; } if (!url.startsWith('http://') && !url.startsWith('https://')) url = 'https://' + url; try { const proxyUrl = 'https://api.allorigins.win/raw?url=' + encodeURIComponent(url); window.open(proxyUrl, '_blank'); if (proxyInputElement) proxyInputElement.value = ''; showDimaNotification('Opening through proxy: ' + url); } catch (e) { showDimaNotification('Could not open URL through proxy: ' + url); console.error('Proxy URL open error:', e); } }; }",
        "const proxyButtonAltElement = document.getElementById('dima-proxy-button-alt'); const proxyInputAltElement = document.getElementById('dima-proxy-input-alt'); if (proxyButtonAltElement) { proxyButtonAltElement.onclick = function() { let url = proxyInputAltElement ? proxyInputAltElement.value.trim() : ''; if (!url) { showDimaNotification('Please enter a URL.'); return; } if (!url.startsWith('http://') && !url.startsWith('https://')) url = 'https://' + url; try { const proxyUrl = 'https://www.croxyproxy.com/?url=' + encodeURIComponent(url); window.open(proxyUrl, '_blank'); if (proxyInputAltElement) proxyInputAltElement.value = ''; showDimaNotification('Opening through CroxyProxy: ' + url); } catch (e) { showDimaNotification('Could not open URL through CroxyProxy: ' + url); console.error('CroxyProxy URL open error:', e); } }; }",
...
"}", // End of initializeMainMenu
        ...
        "    };",
        "}",
        "const fakeLoaderBtn = document.getElementById('dima-copy-fakeloader');",
        "if (fakeLoaderBtn) {",
        "    fakeLoaderBtn.onclick = function() {",
        "        const code = `let loading = document.createElement('div');\nloading.innerHTML = '<h1>Loading...</h1>';\nloading.style.cssText = 'position:fixed;top:0;left:0;width:100%;height:100%;background:black;color:white;font-size:3em;text-align:center;padding-top:20%;z-index:9999;';\ndocument.body.appendChild(loading);`;",
        "        navigator.clipboard.writeText(code).then(() => {",
        "            showDimaNotification('Fake Loading Screen code copied to clipboard!');",
        "        });",
        "    };",
        "}",
        "const xrayBtn = document.getElementById('dima-copy-xray');",
        "if (xrayBtn) {",
        "    xrayBtn.onclick = function() {",
        "        const code = `const css = '* { outline: 1px solid red !important; }';\nconst style = document.createElement('style');\nstyle.innerText = css;\ndocument.head.appendChild(style);`;",
        "        navigator.clipboard.writeText(code).then(() => {",
        "            showDimaNotification('X-Ray Vision code copied to clipboard!');",
        "        });",
        "    };",
        "}",
        "const removerBtn = document.getElementById('dima-copy-remover');",
        "if (removerBtn) {",
        "    removerBtn.onclick = function() {",
        "        const code = `document.body.addEventListener('click', function(e){ e.target.remove(); }, true);`;",
        "        navigator.clipboard.writeText(code).then(() => {",
        "            showDimaNotification('Element Remover Tool code copied to clipboard!');",
        "        });",
        "    };",
        "}",
        "const qrBtn = document.getElementById('dima-copy-qrcode');",
        "if (qrBtn) {",
        "    qrBtn.onclick = function() {",
        "        const code = 'window.open(`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${location.href}`);';",
        "        navigator.clipboard.writeText(code).then(() => {",
        "            showDimaNotification('QR Code Generator code copied to clipboard!');",
        "        });",
        "    };",
        "}",
        "const ttsBtn = document.getElementById('dima-copy-tts');",
        "if (ttsBtn) {",
        "    ttsBtn.onclick = function() {",
        "        const code = `const msg = new SpeechSynthesisUtterance(prompt('Enter text to speak:'));\nwindow.speechSynthesis.speak(msg);`;",
        "        navigator.clipboard.writeText(code).then(() => {",
        "            showDimaNotification('Text-to-Speech Reader code copied to clipboard!');",
        "        });",
        "    };",
        "}",
        "const fireworksBtn = document.getElementById('dima-copy-fireworks');",
        "if (fireworksBtn) {",
        "    fireworksBtn.onclick = function() {",
        "        const code = `const script = document.createElement('script');\nscript.src = 'https://cdn.jsdelivr.net/npm/canvas-confetti@1.4.0/dist/confetti.browser.min.js';\ndocument.body.appendChild(script);\nscript.onload = () => document.body.addEventListener('click', () => confetti());`;",
        "        navigator.clipboard.writeText(code).then(() => {",
        "            showDimaNotification('Fireworks on Click code copied to clipboard!');",
        "        });",
        "    };",
        "}",
        "const aiChatBox = document.getElementById('dima-ai-chat-box');",
        "const aiChatMessage = document.getElementById('dima-ai-chat-message');",
        "const aiChatSend = document.getElementById('dima-ai-chat-send');",
        ...
        "    messageElement.style.marginBottom = '8px';",
        "    messageElement.style.padding = '8px';",
        "    messageElement.style.backgroundColor = sender === 'AI' ? 'rgba(33,150,243,0.08)' : 'var(--dima-bg-light)';",
        "    messageElement.style.borderRadius = '8px';",
        "    messageElement.style.border = '1px solid var(--dima-border)';",
        "    messageElement.innerHTML = `<span style='color: var(--dima-accent); font-weight: 600;'>${sender}:</span> ${message}`;",
        ...
        "    aiChatMessage.value = '';",
        "    appendAIMessage('AI', '<span style=\"color:#888\">Thinking...</span>');",
        "    aiChatBox.scrollTop = aiChatBox.scrollHeight;",
        "    try {",
        ...
        "            appendAIMessage('AI', data[0].generated_text);",
        "        } else if (data && data.generated_text) {",
        "            appendAIMessage('AI', data.generated_text);",
        "        } else if (data && data.error) {",
        "            appendAIMessage('AI', `<span style='color:red'>Error: ${data.error}</span>`);",
        "        } else {",
        "            appendAIMessage('AI', '<span style=\"color:red\">No response from AI.</span>');",
        "        }",
        "    } catch (err) {",
        "        aiChatBox.removeChild(aiChatBox.lastChild);",
        "        appendAIMessage('AI', `<span style='color:red'>Error: ${err.message}</span>`);",
        "    }",
        "}",

        "if (aiChatSend && aiChatMessage) {",
        ...
        "        }",
        "    };",
        "    aiChatMessage.onkeypress = function(e) {",
        "        if (e.key === 'Enter') {",
        "            aiChatSend.click();",
        "        }",
        "    };",
...
(function() {
    const attachFakeLoaderCopyHandler = () => {
        const fakeLoaderBtn = document.getElementById('dima-copy-fakeloader');
        if (fakeLoaderBtn && !fakeLoaderBtn._dimaHandlerAttached) {
            fakeLoaderBtn.onclick = function() {
                const code = `let loading = document.createElement('div');\nloading.innerHTML = '<h1>Loading...</h1>';\nloading.style.cssText = 'position:fixed;top:0;left:0;width:100%;height:100%;background:black;color:white;font-size:3em;text-align:center;padding-top:20%;z-index:9999;';\ndocument.body.appendChild(loading);`;
                navigator.clipboard.writeText(code).then(() => {
                    if (typeof showDimaNotification === 'function') {
            ...
            fakeLoaderBtn._dimaHandlerAttached = true;
        }
    };
    attachFakeLoaderCopyHandler();
    const observer = new MutationObserver(attachFakeLoaderCopyHandler);
    observer.observe(document.body, { childList: true, subtree: true });
})();

(function() {
    const attachXRayCopyHandler = () => {
        const xrayBtn = document.getElementById('dima-copy-xray');
        if (xrayBtn && !xrayBtn._dimaHandlerAttached) {
            xrayBtn.onclick = function() {
                const code = `const css = '* { outline: 1px solid red !important; }';\nconst style = document.createElement('style');\nstyle.innerText = css;\ndocument.head.appendChild(style);`;
                navigator.clipboard.writeText(code).then(() => {
                    if (typeof showDimaNotification === 'function') {
            ...
            xrayBtn._dimaHandlerAttached = true;
        }
    };
    attachXRayCopyHandler();
    const observer = new MutationObserver(attachXRayCopyHandler);
    observer.observe(document.body, { childList: true, subtree: true });
})();

(function() {
    const attachRemoverCopyHandler = () => {
        const removerBtn = document.getElementById('dima-copy-remover');
        if (removerBtn && !removerBtn._dimaHandlerAttached) {
            removerBtn.onclick = function() {
                const code = `document.body.addEventListener('click', function(e){ e.target.remove(); }, true);`;
                navigator.clipboard.writeText(code).then(() => {
                    if (typeof showDimaNotification === 'function') {
            ...
            removerBtn._dimaHandlerAttached = true;
        }
    };
    attachRemoverCopyHandler();
    const observer = new MutationObserver(attachRemoverCopyHandler);
    observer.observe(document.body, { childList: true, subtree: true });
})();

(function() {
    const attachQRCodeCopyHandler = () => {
        const qrBtn = document.getElementById('dima-copy-qrcode');
        if (qrBtn && !qrBtn._dimaHandlerAttached) {
            qrBtn.onclick = function() {
                const code = 'window.open(`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${location.href}`);';
                navigator.clipboard.writeText(code).then(() => {
                    if (typeof showDimaNotification === 'function') {
            ...
            qrBtn._dimaHandlerAttached = true;
        }
    };
    attachQRCodeCopyHandler();
    const observer = new MutationObserver(attachQRCodeCopyHandler);
    observer.observe(document.body, { childList: true, subtree: true });
})();

(function() {
    const attachTTSHandler = () => {
        const ttsBtn = document.getElementById('dima-copy-tts');
        if (ttsBtn && !ttsBtn._dimaHandlerAttached) {
            ttsBtn.onclick = function() {
                const code = `const msg = new SpeechSynthesisUtterance(prompt('Enter text to speak:'));
window.speechSynthesis.speak(msg);`;
                navigator.clipboard.writeText(code).then(() => {
            ...
            ttsBtn._dimaHandlerAttached = true;
        }
    };
    attachTTSHandler();
    const observer = new MutationObserver(attachTTSHandler);
    observer.observe(document.body, { childList: true, subtree: true });
})();

(function() {
    const attachFireworksHandler = () => {
        const fireworksBtn = document.getElementById('dima-copy-fireworks');
        if (fireworksBtn && !fireworksBtn._dimaHandlerAttached) {
            fireworksBtn.onclick = function() {
                const code = `const script = document.createElement('script');\nscript.src = 'https://cdn.jsdelivr.net/npm/canvas-confetti@1.4.0/dist/confetti.browser.min.js';\ndocument.body.appendChild(script);\nscript.onload = () => document.body.addEventListener('click', () => confetti());`;
                navigator.clipboard.writeText(code).then(() => {
                    if (typeof showDimaNotification === 'function') {
            ...
            fireworksBtn._dimaHandlerAttached = true;
        }
    };
    attachFireworksHandler();
    const observer = new MutationObserver(attachFireworksHandler);
    observer.observe(document.body, { childList: true, subtree: true });
})();
